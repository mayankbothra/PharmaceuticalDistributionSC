...
import UserInterface.Wholesaler.SeniorManager.WholesalerSeniorManagerWorkAreaJPanel;
 ...
 * @author mayank
 */
public class WholesalerSeniorManagerView extends View {

    JPanel userProcessContainer;
    UserAccount userAccount;
    
    public WholesalerSeniorManagerView(JPanel userProcessContainer, UserAccount userAccount) {
    ...
    public JPanel returnPanel() {
        ...
        try {
            ...
            if (d.before(new Date())) {
                ...
                return new WholesalerSeniorManagerWorkAreaJPanel(userProcessContainer, userAccount);
            }
            }
            else{
                return new WholesalerSeniorManagerWorkAreaJPanel(userProcessContainer, userAccount);
