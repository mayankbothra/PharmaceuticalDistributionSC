...
import UserInterface.Hospital.InventoryManager.HospitalInventoryManagerWorkAreaJPanel;
 ...
 * @author Mayank
 */
public class HospitalInventoryManagerView extends View {

    JPanel userProcessContainer;
    UserAccount userAccount;
    
    public HospitalInventoryManagerView(JPanel userProcessContainer, UserAccount userAccount) {
    ...
    public JPanel returnPanel() {
        ...
        try {
            ...
            if (d.before(new Date())) {
                ...
                return new HospitalInventoryManagerWorkAreaJPanel(userProcessContainer, userAccount);
            }
               }
               else {
                   return new HospitalInventoryManagerWorkAreaJPanel(userProcessContainer, userAccount);
