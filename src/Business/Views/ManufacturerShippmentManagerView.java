...
import UserInterface.Manufacturer.ShippingManager.ManufacturerShippingManagerWorkAreaJPanel;
 ...
 * @author Mayank
 */
public class ManufacturerShippmentManagerView extends View {

    JPanel userProcessContainer;
    UserAccount userAccount;
    
    public ManufacturerShippmentManagerView(JPanel userProcessContainer, UserAccount userAccount) {
    ...
    public JPanel returnPanel() {
        ...
        try {
            ...
            if (d.before(new Date())) {
                ...
                return new ManufacturerShippingManagerWorkAreaJPanel(userProcessContainer, userAccount);
            }
            }
            else{
                return new ManufacturerShippingManagerWorkAreaJPanel(userProcessContainer, userAccount);
