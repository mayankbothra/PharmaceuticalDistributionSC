 ...
 * @author mayank
 */
public class ManufacturingManagerView extends View {

    JPanel userProcessContainer;
    UserAccount userAccount;
    
    public ManufacturingManagerView(JPanel userProcessContainer, UserAccount userAccount) {
    ...
    public JPanel returnPanel() {
        ...
        try {
            ...
            if (d.before(new Date())) {
                ...
                return new ManufacturingManagerWorkAreaJPanel(userProcessContainer, userAccount);
            }
            }
            else{
                return new ManufacturingManagerWorkAreaJPanel(userProcessContainer, userAccount);
