...
import UserInterface.Manufacturer.ManufacturingManager.ManufacturingManagerWorkAreaJPanel;
 ...
 * @author mayank
 */
public class ManufacturerSeniorManagerView extends View {

    JPanel userProcessContainer;
    UserAccount userAccount;
    
    public ManufacturerSeniorManagerView(JPanel userProcessContainer, UserAccount userAccount) {
    ...
    public JPanel returnPanel() {
        ...
        try {
            ...
            if (d.before(new Date())) {
                ...
                return new ManufacturerSeniorManagerWorkAreaJPanel(userProcessContainer, userAccount);
            }
            }
            else{
                return new ManufacturerSeniorManagerWorkAreaJPanel(userProcessContainer, userAccount);
