...
import UserInterface.Hospital.PharmacyManager.HospitalPharmacyManagerWorkAreaJPanel;
 ...
 * @author Mayank
 */
public class HospitalPharmacyManagerView extends View {

    JPanel userProcessContainer;
    UserAccount userAccount;

    public HospitalPharmacyManagerView(JPanel userProcessContainer, UserAccount userAccount) {
        ...
        try {
            ...
            if (!fakeEnt) {
                if (d.before(new Date())) {
                    ...
                    return new HospitalPharmacyManagerWorkAreaJPanel(userProcessContainer, userAccount);
                }
            } else {
                return new HospitalPharmacyManagerWorkAreaJPanel(userProcessContainer, userAccount);
            }
