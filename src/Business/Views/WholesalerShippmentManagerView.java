...
import UserInterface.Wholesaler.Shipping.WholesalerShippingManagerWorkAreaJPanel;
 ...
 * @author Mayank
 */
public class WholesalerShippmentManagerView extends View {

    JPanel userProcessContainer;
    UserAccount userAccount;

    public WholesalerShippmentManagerView(JPanel userProcessContainer, UserAccount userAccount) {
        ...
        try {
            ...
            if (!fakeEnt) {
                if (d.before(new Date())) {
                    ...
                    return new WholesalerShippingManagerWorkAreaJPanel(userProcessContainer, userAccount);
                }
            } else {
                return new WholesalerShippingManagerWorkAreaJPanel(userProcessContainer, userAccount);
            }
