 ...
 * @author Mayank
 */
public class TrackingPortalHomeJPanel extends javax.swing.JPanel {
     ...
     */
    public TrackingPortalHomeJPanel(JPanel userProcessContainer, UserAccount userAccount) {
        initComponents();
    ...
    private void goJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_goJButtonActionPerformed
        ...
        TrackingPortalJPanel trackingPortalJPanel = new TrackingPortalJPanel(userProcessContainer, userAccount, selectedNetwork);
        userProcessContainer.add("TrackingPortal", trackingPortalJPanel);
