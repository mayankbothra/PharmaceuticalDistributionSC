...
public class ViewWorkQueueJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        processShippmentJButton = new javax.swing.JButton();
        ...
        processShippmentJButton.setFont(new java.awt.Font("Times New Roman", 1, 15)); // NOI18N
        processShippmentJButton.setText("Process Shippment");
        processShippmentJButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                processShippmentJButtonActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(processShippmentJButton, javax.swing.GroupLayout.PREFERRED_SIZE, 177, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(processShippmentJButton)
                    .addComponent(backJButton)
                    .addComponent(assignToMeJButton))
    ...
    private void processShippmentJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processShippmentJButtonActionPerformed
        // TODO add your handling code here:
        ...
        ShipWorkRequest request = (ShipWorkRequest)workQueueJTable.getValueAt(selectedRow, 0);
       ...
       if (request.getStatus() == WorkRequest.Status.Shipped) {
            JOptionPane.showMessageDialog(null, "This Order Has Already Been Shipped");
            return;
        }
       
        ProcessShippmentJPanel processShippmentJPanel = new ProcessShippmentJPanel(userProcessContainer, selectedEnterprise, userAccount, selectedNetwork, (ShipWorkRequest)request, this);
        userProcessContainer.add("ProcessRequest", processShippmentJPanel);
        CardLayout cardLayout = (CardLayout) userProcessContainer.getLayout();
        cardLayout.next(userProcessContainer);
    }//GEN-LAST:event_processShippmentJButtonActionPerformed
    ...
    private javax.swing.JButton processShippmentJButton;
