...
public class ViewWorkQueueJPanel extends javax.swing.JPanel {
    ...
    private void viewDetailsJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewDetailsJButtonActionPerformed
        ...
        if (r.toString().equals(WorkRequest.Type.ReceiveShipmentWorkRequest.toString())) {

            ReceiveShippmentWorkRequest request = (ReceiveShippmentWorkRequest) workQueueJTable.getValueAt(selectedRow, 0);


            if (request.getStatus() == WorkRequest.Status.OrderReceived) {
            ...
            boolean fakeEnt1 = false;
            boolean fakeEnt2 = false;

            for (Employee emp : reqEnterprise.getEmployeeDirectory().getEmployeeList()) {
            ...
            if (!fakeEnt2) { //for selectedFakeEnt
                if (!fakeEnt1) {  // for requestedFakeEnt
                    for (Enterprise ee : govt.getApprovedEnterpriseList()) {
                        if (ee == reqEnterprise) {
                            try {
                                String expDate = ee.getLicenseExpiryDate();
                    ...
                    if (flag) {
                        JOptionPane.showMessageDialog(null, "Order Is Received From  Licensed Manufacturer");
                        int option = JOptionPane.showConfirmDialog(null, "View Order Details and Process Order", "View", JOptionPane.YES_NO_OPTION);

                        if (option == JOptionPane.YES_OPTION) {
                            ViewReceiveShippmentDetailsJPanel viewDetailsJPanel = new ViewReceiveShippmentDetailsJPanel(userProcessContainer, selectedEnterprise, userAccount, selectedNetwork, request, this);
                            userProcessContainer.add("ViewDetails", viewDetailsJPanel);
                            CardLayout cardLayout = (CardLayout) userProcessContainer.getLayout();
                            cardLayout.next(userProcessContainer);
                        } else {
                            JOptionPane.showMessageDialog(null, "Order Processing Pending");
                        }
                    } else {
                        JOptionPane.showMessageDialog(null, "Order Is From Unlicensed Manufacturer");
                        JOptionPane.showMessageDialog(null, "Order Added To Rejected Order List And Complaint Sent To FDA");
                        request.setStatus(WorkRequest.Status.OrderRejected);
                        ...
                        req.setComplaintType(ComplaintWorkRequest.complaintType.UnlicensedEnterprise);
                        req.setRequest(request);
                    ...
                    JOptionPane.showMessageDialog(null, "Order Is From FAKE Manufacturer");
                    JOptionPane.showMessageDialog(null, "Order Added To Rejected Order List And Complaint Sent To FDA");
                    request.setStatus(WorkRequest.Status.FAKE);
                    SimpleDateFormat sdf = new SimpleDateFormat("MM dd yy HH:mm:ss");
                    String d = sdf.format(new Date());
                    request.setResolveDate(d);
                    ...
                    req.setFromEnterprise(selectedEnterprise);
                    req.setAgainstEnterprise(reqEnterprise);
                    req.setComplaintType(ComplaintWorkRequest.complaintType.Fake);
                    req.setRequest(request);
        ...
        if (r.toString().equals(WorkRequest.Type.OrderDrugs.toString())) {
            OrderDrugsWorkRequest request = (OrderDrugsWorkRequest) workQueueJTable.getValueAt(selectedRow, 0);

            if (request.getStatus() == WorkRequest.Status.OrderApproved) {
                JOptionPane.showMessageDialog(null, "This Order Has Already Been Approved");
                return;
            }

            if (request.getStatus() == WorkRequest.Status.OrderRejected) {
                JOptionPane.showMessageDialog(null, "This Order Has Been Rejected");
                return;
            }
            ...
            if (!fakeEnt2) {
                if (!fakeEnt1) {
                    ...
                    if (flag) {
                        JOptionPane.showMessageDialog(null, "Order Is From Licensed Hospital");
                        int option = JOptionPane.showConfirmDialog(null, "View Order Details and Process Order", "View", JOptionPane.YES_NO_OPTION);

                        if (option == JOptionPane.YES_OPTION) {
                            ViewOrderDetailsJPanel viewOrderDetailsJPanel = new ViewOrderDetailsJPanel(userProcessContainer, selectedEnterprise, userAccount, selectedNetwork, request, this);
                        ...
                        JOptionPane.showMessageDialog(null, "Order Is From Unlicensed Hospital");
                        JOptionPane.showMessageDialog(null, "Order Added To Rejected Order List And Complaint Sent To FDA");
                        request.setStatus(WorkRequest.Status.OrderRejected);
                        SimpleDateFormat sdf = new SimpleDateFormat("MM dd yy HH:mm:ss");
                        String d = sdf.format(new Date());
                    ...
                    JOptionPane.showMessageDialog(null, "Order Is From FAKE Hospital Pharmacy");
                    JOptionPane.showMessageDialog(null, "Order Added To Rejected Order List And Complaint Sent To FDA");
                    request.setStatus(WorkRequest.Status.OrderRejected);
                    SimpleDateFormat sdf = new SimpleDateFormat("MM dd yy HH:mm:ss");
                    String d = sdf.format(new Date());
