...
public class ViewOrderDetailsJPanel extends javax.swing.JPanel {
     ...
     */
    public ViewOrderDetailsJPanel(JPanel userProcessContainer, Enterprise selectedEnterprise, UserAccount userAccount, Network selectedNetwork, OrderDrugsWorkRequest request, ViewWorkQueueJPanel viewWorkQueueJPanel) {
        initComponents();
    ...
    private void approveOrderJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_approveOrderJButtonActionPerformed
        ...
        if (count == size) {
            ...
            ShipWorkRequest shipRequest = (ShipWorkRequest) selectedEnterprise.getWholesalerShippingOrganization().getWorkQueue().newWorkRequest(WorkRequest.Type.ShipWorkRequest);
        ...
        for (InventoryItem ii : selectedEnterprise.getInventory().getInventoryItemList()) {
            if (ii.getDrug() == oi.getDrug()) {
                if (oi.getQuantity() <= ii.getQuantity()) {
                    ...
                    JOptionPane.showMessageDialog(null, "Required Quantity Not Available In Inventory");
