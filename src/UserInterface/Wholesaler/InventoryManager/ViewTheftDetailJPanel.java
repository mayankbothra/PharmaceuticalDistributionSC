...
public class ViewTheftDetailJPanel extends javax.swing.JPanel {
     ...
     */
    public ViewTheftDetailJPanel(JPanel userProcessContainer, Enterprise reqEnterprise, UserAccount userAccount, Network selectedNetwork, ReceiveShippmentWorkRequest request, Enterprise selectedEnterprise) {
        initComponents();
        this.userProcessContainer = userProcessContainer;
        this.selectedEnterprise = (Wholesaler) selectedEnterprise;
        this.reqEnterprise = (Manufacturer)reqEnterprise;
    ...
    private void refreshInventory() {
        ...
        for (InventoryItem i : request.getShipWorkRequest().getTheftInventory().getInventoryItemList()) {
