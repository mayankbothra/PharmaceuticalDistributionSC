...
public class ProcessShippmentJPanel extends javax.swing.JPanel{
    ...
    public ProcessShippmentJPanel(JPanel userProcessContainer, Enterprise selectedEnterprise, UserAccount userAccount, Network selectedNetwork, ShipWorkRequest request, ViewWorkQueueJPanel viewWorkQueueJPanel) {
        ...
        wNetwork = business.getNetworkDirectory().getMyNetwork(request.getOrderDrugsWorkRequest().getSender());
        wEnterprise = (Wholesaler)wNetwork.getEnterpriseDirectory().getMyEnterprise(request.getOrderDrugsWorkRequest().getSender());
        wholesalerNameJLabel.setText(wEnterprise.getEnterpriseName());
    }
...
//    }
    ...
    private void initComponents() {
        ...
        wholesalerNameTitleJLabel.setText("Wholesaler Name");
    ...
    private void shipOrderJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_shipOrderJButtonActionPerformed
        // TODO add your handling code here:
//        disEnterprise
        ReceiveShippmentWorkRequest receiveShippmentWorkRequest = (ReceiveShippmentWorkRequest)wEnterprise.getWholesalerInventoryManagementOrganization().getWorkQueue().newWorkRequest(WorkRequest.Type.ReceiveShipmentWorkRequest);
