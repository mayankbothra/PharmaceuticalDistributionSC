...
public class ViewWorkQueueJPanel extends javax.swing.JPanel {
    ...
    private void viewDetailsJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewDetailsJButtonActionPerformed
       ...
       if (request.getStatus() == WorkRequest.Status.BatchCreated) {
        ...
        if (request.toString().equals(WorkRequest.Type.ApproveDrugRequest.toString())) {
            ViewApprovedDetailsJPanel viewDetailsJPanel = new ViewApprovedDetailsJPanel(userProcessContainer, selectedEnterprise, userAccount, selectedNetwork, (ApproveDrugWorkRequest) request, this);
            userProcessContainer.add("ViewApprovedDetails", viewDetailsJPanel);
            CardLayout cardLayout = (CardLayout) userProcessContainer.getLayout();
            cardLayout.next(userProcessContainer);
        } else if (request.toString().equals(WorkRequest.Type.RejectDrugRequest.toString())) {
            ViewRejectDetailsJPanel viewRejectDetailsJPanel = new ViewRejectDetailsJPanel(userProcessContainer, selectedEnterprise, userAccount, selectedNetwork, (RejectDrugWorkRequest) request, this);
            userProcessContainer.add("ViewRejectedDetails", viewRejectDetailsJPanel);
            CardLayout cardLayout = (CardLayout) userProcessContainer.getLayout();
            cardLayout.next(userProcessContainer);
        }
