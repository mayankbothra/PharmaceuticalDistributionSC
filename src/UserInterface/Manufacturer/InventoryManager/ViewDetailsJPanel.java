...
public class ViewDetailsJPanel extends javax.swing.JPanel {
    ...
    OrderDrugsWorkRequest request;
    ViewWorkQueueJPanel viewWorkQueueJPanel;

    /**
     * Creates new form BusinessAdminJPanel
     */
    public ViewDetailsJPanel(JPanel userProcessContainer, Enterprise selectedEnterprise, UserAccount userAccount, Network selectedNetwork, OrderDrugsWorkRequest request, ViewWorkQueueJPanel viewWorkQueueJPanel) {
        initComponents();
    ...
    private void initComponents() {
        ...
        theftDemoJButton = new javax.swing.JButton();
        ...
        theftDemoJButton.setFont(new java.awt.Font("Times New Roman", 1, 15)); // NOI18N
        theftDemoJButton.setText("Theft Demo");
        theftDemoJButton.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        theftDemoJButton.setPreferredSize(new java.awt.Dimension(80, 30));
        theftDemoJButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                theftDemoJButtonActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                .addComponent(theftDemoJButton, javax.swing.GroupLayout.PREFERRED_SIZE, 133, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(theftDemoJButton, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void approveOrderJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_approveOrderJButtonActionPerformed
        ...
        if (count == size) {
            ...
            ShipWorkRequest shipRequest = (ShipWorkRequest) selectedEnterprise.getShippingOrganization().getWorkQueue().newWorkRequest(WorkRequest.Type.ShipWorkRequest);
            shipRequest.setOrderDrugsWorkRequest(request);
            Inventory inventory = new Inventory();
            inventory.setInventoryItemList(iilist);
            shipRequest.setInventory(inventory);
            shipRequest.setSender(userAccount);
            SimpleDateFormat sdf = new SimpleDateFormat("MM dd yy HH:mm:ss");
            String currentDate = sdf.format(new Date());
            shipRequest.setRequestDate(currentDate);
            shipRequest.setStatus(WorkRequest.Status.MakeShippment);
            request.setResolveDate(currentDate);
            request.setStatus(WorkRequest.Status.OrderApproved);
            
            viewWorkQueueJPanel.refreshWorkQueue();
            JOptionPane.showMessageDialog(null, "Order Approved And Sent To Shipping Department");
            userProcessContainer.remove(this);
            CardLayout cardLayout = (CardLayout)userProcessContainer.getLayout();
            cardLayout.previous(userProcessContainer);
    ...
    private void processJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processJButtonActionPerformed
        ...
        if (selectedRow < 0) {
            JOptionPane.showMessageDialog(null, "Select a Drug To Process Order");
            return;
        }

        OrderItem oi = (OrderItem) orderJTable.getValueAt(selectedRow, 1);

        for (InventoryItem ii : selectedEnterprise.getInventory().getInventoryItemList()) {
            if (ii.getDrug() == oi.getDrug()) {
                if (oi.getQuantity() <= ii.getQuantity()) {
                    JOptionPane.showMessageDialog(null, "Required Quantity Available In Inventory");
                    ...
                    JOptionPane.showMessageDialog(null, "Required Quantity Not Available In Inventory. Place a Batch Creation Request");

                    Drug drug = oi.getDrug();

                    CreateBatchWorkRequest req = (CreateBatchWorkRequest) selectedEnterprise.getManufacturingOrganization().getWorkQueue().newWorkRequest(WorkRequest.Type.CreateBatchRequest);
                    req.setDrug(drug);
                    SimpleDateFormat sdf = new SimpleDateFormat("MM dd yy HH:mm:ss");
                    String currentDate = sdf.format(new Date());
                    req.setRequestDate(currentDate);
                    req.setSender(userAccount);
                    req.setStatus(WorkRequest.Status.CreateBatch);

                    JOptionPane.showMessageDialog(null, "Batch Creation Request Placed");
    ...
    private void theftDemoJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_theftDemoJButtonActionPerformed
        // TODO add your handling code here:
        int count = 0;
        ...
        if (count == size) {
            ...
            shipRequest.setOrderDrugsWorkRequest(request);
            Inventory theftInventory = new Inventory();
            int q = 0;
            
            for(InventoryItem i : iilist) {
                theftInventory.getInventoryItemList().add(i);
                break;
            }
            
            for(InventoryItem ii : theftInventory.getInventoryItemList()) {
                iilist.remove(ii);
            }
            ...
            inventory.setInventoryItemList(iilist);
            shipRequest.setInventory(inventory);
            shipRequest.setTheftInventory(theftInventory);
            shipRequest.setSender(userAccount);
            SimpleDateFormat sdf = new SimpleDateFormat("MM dd yy HH:mm:ss");
            String currentDate = sdf.format(new Date());
            shipRequest.setRequestDate(currentDate);
    ...
    }//GEN-LAST:event_theftDemoJButtonActionPerformed
    ...
    private javax.swing.JButton theftDemoJButton;
