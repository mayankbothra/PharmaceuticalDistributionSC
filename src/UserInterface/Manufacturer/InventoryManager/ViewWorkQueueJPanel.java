...
public class ViewWorkQueueJPanel extends javax.swing.JPanel {
    ...
    private void viewDetailsJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewDetailsJButtonActionPerformed
        ...
        if (request.getStatus() == WorkRequest.Status.FAKE) {
            JOptionPane.showMessageDialog(null, "This Order Is FAKE");
            return;
        }
        ...
        if (!fakeEnt2) { //for selectedFakeEnt
            if (!fakeEnt1) { // for requestedFakeEnt
                ...
                if (flag) {
                    JOptionPane.showMessageDialog(null, "Order Is From Licensed Distributor");
                    int option = JOptionPane.showConfirmDialog(null, "View Order Details and Process Order", "View", JOptionPane.YES_NO_OPTION);

                    if (option == JOptionPane.YES_OPTION) {
                        ViewDetailsJPanel viewDetailsJPanel = new ViewDetailsJPanel(userProcessContainer, selectedEnterprise, userAccount, selectedNetwork, request, this);
                    ...
                    JOptionPane.showMessageDialog(null, "Order Is From Unlicensed Distributor");
                ...
                JOptionPane.showMessageDialog(null, "Order Is From FAKE Distributor");
                JOptionPane.showMessageDialog(null, "Order Added To Rejected Order List And Complaint Sent To FDA");
    ...
    private void assignToMeJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_assignToMeJButtonActionPerformed
        ...
        request.setStatus(WorkRequest.Status.OrderProcessing);
