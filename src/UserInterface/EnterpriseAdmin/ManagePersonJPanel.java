...
Network selectedNetwork;
     ...
     */
    public ManagePersonJPanel(JPanel userProcessContainer, Enterprise selectedEnterprise, UserAccount userAccount, Network selectedNetwork) {
        initComponents();
    ...
    public void refreshPerson() {
        ...
        int rowCount = personJTable.getRowCount();
        
        for(int i = rowCount - 1 ; i >= 0; i--) {
            ((DefaultTableModel)personJTable.getModel()).removeRow(i);
        }
        
        for(Person p : selectedEnterprise.getPersonDirectory().getPersonList()) {
            Object[] row = new Object[2];
            row[0] = p;
            row[1] = p.getPhone();
            
            ((DefaultTableModel)personJTable.getModel()).addRow(row);
            }
    }
    ...
    private void initComponents() {
        ...
        titleJLabel.setText("Manage Person");
    ...
    private void createJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createJButtonActionPerformed
        // TODO add your handling code here:
        AddPersonJPanel addPersonJPanel = new AddPersonJPanel(userProcessContainer, selectedEnterprise, userAccount, selectedNetwork, this);
        userProcessContainer.add("AddPerson", addPersonJPanel);
        CardLayout cardLayout = (CardLayout)userProcessContainer.getLayout();
