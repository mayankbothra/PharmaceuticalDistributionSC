...
ManagePersonJPanel managePersonJPanel;

    /**
     * Creates new form CreateCustomerJPanel
     */
    public AddPersonJPanel(JPanel userProcessContainer, Enterprise selectedEnterprise, UserAccount userAccount, Network selectedNetwork, ManagePersonJPanel managePersonJPanel) {
        initComponents();
        this.userProcessContainer = userProcessContainer;
        this.selectedNetwork = selectedNetwork;
        this.userAccount = userAccount;
        this.selectedEnterprise = selectedEnterprise;
        this.managePersonJPanel = (ManagePersonJPanel)managePersonJPanel;
    ...
    private void initComponents() {
        ...
        titleJLabel.setText("Create Person");

        adminDetailJLabel.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        adminDetailJLabel.setText("Person Detail");
    ...
    private void backJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backJButtonActionPerformed
        ...
        managePersonJPanel.refreshPerson();
