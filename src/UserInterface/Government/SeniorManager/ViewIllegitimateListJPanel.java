...
public class ViewIllegitimateListJPanel extends javax.swing.JPanel {
    ...
    public void refreshSuspectList() {
        ...
        for (Drug drug : selectedEnterprise.getIllegitimateDrugList()) {
    ...
    private void initComponents() {
        ...
        suspectDrugJTable.getColumnModel().getColumn(0).setPreferredWidth(15);
        suspectDrugJTable.getColumnModel().getColumn(1).setPreferredWidth(12);
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addGroup(layout.createSequentialGroup()
                            ...
                            .addComponent(sendAlertJButton, javax.swing.GroupLayout.PREFERRED_SIZE, 123, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void sendAlertJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendAlertJButtonActionPerformed
        ...
        Drug d = (Drug)suspectDrugJTable.getValueAt(selectedRow, 0);
        ...
        for(Enterprise e : entList) {
            ...
            if(m.getEnterpriseName().equals(d.getManufacturerName())) {
                m.setFlag(false);
                m.setAlertMessage("'" + d.getDrugName() + "' Drug Is Declared Illegitimate");
            }
        }
        ...
        for(Network n : Business.Business.getInstance().getNetworkDirectory().getNetworkList()) {
            for(Enterprise e : n.getEnterpriseDirectory().getEnterpriseList()) {
                for(Enterprise ee : entList) {
                    if(!(e==ee)) {
                        e.setFlag(false);
                        e.setAlertMessage("'" + d.getDrugName() + "' Drug Is Declared Illegitimate. It Belongs To Manufacturer '" + d.getManufacturerName() + "' Manufacturer");
                    }
                }
