 ...
 * @author Mayank
 */
public class ExpiredDrugDetailsJPanel extends javax.swing.JPanel {
     ...
     */
    public ExpiredDrugDetailsJPanel(JPanel userProcessContainer, Enterprise selectedEnterprise, UserAccount userAccount, Network selectedNetwork, ComplaintWorkRequest request) {
        initComponents();
    ...
    private void refreshDrugList() {
        int rowCount = expiredDrugJTable.getRowCount();
        
        for(int i = rowCount - 1; i >= 0; i--) {
            ((DefaultTableModel)expiredDrugJTable.getModel()).removeRow(i);
        }
        
        for(MedicinePackage mp : request.getMedicinePackageList()) {
            Object[] row = new Object[4];
            row[0] = mp.getUniqueID();
            row[1] = mp.getBatch().getDrug().getDrugName();
            row[2] = mp.getBatch().getDrug().getManufacturerName();
            row[3] = mp.getBatch().getExpiryDate();
            
            ((DefaultTableModel)expiredDrugJTable.getModel()).addRow(row);
        }
    }
    ...
    private void initComponents() {
        ...
        expiredDrugJTable = new javax.swing.JTable();
        ...
        drugCatalogTitleJLabel.setText("Expired Drug List");

        expiredDrugJTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
            ...
            new String [] {
                "Unique Id", "Drug Name", "Manufacturer Name", "Expiry Date"
            }
        ) {
        ...
        jScrollPane2.setViewportView(expiredDrugJTable);
    ...
    private javax.swing.JTable expiredDrugJTable;
