...
public class ViewWorkQueueJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        workQueueJTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Type", "Complaint Date", "Sender", "Receiver"
            }
        ) {
        ...
        workQueueJTable.getColumnModel().getColumn(1).setPreferredWidth(12);
        workQueueJTable.getColumnModel().getColumn(2).setPreferredWidth(12);
        workQueueJTable.getColumnModel().getColumn(3).setPreferredWidth(13);
    ...
    private void viewDetailsJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewDetailsJButtonActionPerformed
        ...
        WorkRequest r = (WorkRequest) workQueueJTable.getValueAt(selectedRow, 0);
        ...
        if (r.toString().equals(WorkRequest.Type.ComplaintWorkRequest.toString())) {

            ComplaintWorkRequest request = (ComplaintWorkRequest) r;

            if (request.getComplaintType().equals(ComplaintWorkRequest.complaintType.UnlicensedEnterprise)) {
                ViewUnlicensedComplaintJPanel viewUnlicensedComplaintJPanel = new ViewUnlicensedComplaintJPanel(userProcessContainer, selectedEnterprise, userAccount, selectedNetwork, request, this);
                userProcessContainer.add("ViewUnlicensed", viewUnlicensedComplaintJPanel);
                CardLayout cardLayout = (CardLayout) userProcessContainer.getLayout();
                cardLayout.next(userProcessContainer);
            } else if (request.getComplaintType().equals(ComplaintWorkRequest.complaintType.UnlicensedDrug)) {
                ViewUnlicensedDrugComplaintJPanel viewUnlicensedDrugComplaintJPanel = new ViewUnlicensedDrugComplaintJPanel(userProcessContainer, selectedEnterprise, userAccount, selectedNetwork, request, this);
                userProcessContainer.add("UnlicensedDrug", viewUnlicensedDrugComplaintJPanel);
                CardLayout cardLayout = (CardLayout) userProcessContainer.getLayout();
                cardLayout.next(userProcessContainer);
            } else if (request.getComplaintType().equals(ComplaintWorkRequest.complaintType.ExpiredDrug)) {
                ...
                userProcessContainer.add("ExpiredDetails", expiredDrugDetailsJPanel);
                CardLayout cardLayout = (CardLayout) userProcessContainer.getLayout();
                cardLayout.next(userProcessContainer);
            } else if (request.getComplaintType().equals(ComplaintWorkRequest.complaintType.Fake)) {
                ViewFakeComplaintJPanel viewFakeComplaintJPanel = new ViewFakeComplaintJPanel(userProcessContainer, selectedEnterprise, userAccount, selectedNetwork, request);
                userProcessContainer.add("ViewFake", viewFakeComplaintJPanel);
                CardLayout cardLayout = (CardLayout) userProcessContainer.getLayout();
                cardLayout.next(userProcessContainer);
            }
        }

        if (r.toString().equals(WorkRequest.Type.SuspectDrugWorkRequest.toString())) {

            SuspectDrugWorkRequest request = (SuspectDrugWorkRequest) r;

            ViewSuspectDrugComplaintJPanel viewSuspectDrugComplaintJPanel = new ViewSuspectDrugComplaintJPanel(userProcessContainer, selectedEnterprise, userAccount, selectedNetwork, request);
            userProcessContainer.add("SuspectDrug", viewSuspectDrugComplaintJPanel);
            CardLayout cardLayout = (CardLayout) userProcessContainer.getLayout();
            cardLayout.next(userProcessContainer);

        }
        
        if (r.toString().equals(WorkRequest.Type.SuspectPackageWorkRequest.toString())) {

            SuspectPackageWorkRequest request = (SuspectPackageWorkRequest) r;

            ViewSuspectPackageComplaintJPanel viewSuspectPackageComplaintJPanel = new ViewSuspectPackageComplaintJPanel(userProcessContainer, selectedEnterprise, userAccount, selectedNetwork, request);
            userProcessContainer.add("SuspectPackage", viewSuspectPackageComplaintJPanel);
            CardLayout cardLayout = (CardLayout) userProcessContainer.getLayout();
            cardLayout.next(userProcessContainer);

        }
        
        if (r.toString().equals(WorkRequest.Type.TheftWorkRequest.toString())) {

            TheftWorkRequest request = (TheftWorkRequest)r;

            ViewTheftDetailJPanel viewTheftDetailJPanel = new ViewTheftDetailJPanel(userProcessContainer, selectedEnterprise, userAccount, selectedNetwork, request);
            userProcessContainer.add("TheftRequest", viewTheftDetailJPanel);
            CardLayout cardLayout = (CardLayout) userProcessContainer.getLayout();
            cardLayout.next(userProcessContainer);
